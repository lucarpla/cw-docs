...
In order to configure and use Apple Pay with Rakoon, you need to prepare some business accounts and tools as follows:
...
5. You should store this file in an accessible place. The domain verification step is not completed yet. We're going to get back to this as we configure Apple Pay on the Rakoon.
...
## Enable Apple Pay in Rakoon Dashboard

After configuring Apple Developer Account and Checkout.com, we need to do some steps on the Rakoon dashboard to make Apple Pay fully functional.

1. Head over your restaurant settings in your Rakoon dashboard.
